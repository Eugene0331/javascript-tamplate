class Carousel {
  ...
  _gotoPrev() {
    this._gotoEnd(this.currentSlide - 1);
  }
  ...
  _pause() {
    if (this.isPlaying) {
      ...
      this.pauseBtn.firstChild.classList.remove("fa-pause-circle");
      this.pauseBtn.firstChild.classList.add("fa-play-circle");
  ...
  _play() {
    if (!this.isPlaying) {
      this.pauseBtn.firstChild.classList.remove("fa-play-circle");
      this.pauseBtn.firstChild.classList.add("fa-pause-circle");
      this.isPlaying = true;
  ...
  _indicate(e) {
    ...
    if (target && target.classList.contains("indicator")) {
      this._pause();
      this._gotoEnd(+target.dataset.slideTo);
    }
  }
